pipeline {
    ...
    environment {      
        ...
        qaip = '192.168.1.24'
        uatip = '192.168.1.100'
        serverport = '9023'              //服务的端口号
        jenkinstemptransfer = '/data/app/jenkins-temp-transfer/gpyh-user-microfront'     //临时存放运输文件路径
        webhome = '/data/app/jenkins-deploy/ecommerce/gpyh-user-microfront'      //项目路径
        webpath = 'dist'  //配置文件路径
        webname = 'gpyh-user-microfront'   //项目名称
   }
