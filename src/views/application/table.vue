<template>
  <div class="">
    <f-crud ref="tcrud" :option="option" :operate="operate" :formProps="formProps" v-model="form" class="p-[12px]">
      ...
      <template #menu="{ row }">
        ...
        <el-button type="primary" link @click="openAdd(row, 'update')">编辑 </el-button>
        <el-button type="primary" link @click="openMove(row)">移动 </el-button>
        <el-button type="primary" link @click="openDel(row)">删除 </el-button>
      </template>
    </f-crud>
