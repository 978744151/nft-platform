<template>
  ...
  <ElScrollbar
    style="min-width: 166px; height: 100%; padding-bottom: 50px"
    class="overflow-auto"
    v-if="!loading"
  >
    <el-tree
    ...
    >
      <template #default="{ node, data }">
        <span class="custom-tree-node">
          ...
          <el-dropdown>
            <span
              class="el-dropdown-link ml-2"
              style="color: #0065ff; font-size: 20px; height: 33px"
            >
              ...
            </span>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="openAdd(node, 'add')"
                  >创建组织</el-dropdown-item
                >
                <el-dropdown-item @click="openAdd(node, 'update')"
                  >编辑组织</el-dropdown-item
                >
                <el-dropdown-item @click="openMove(node)">移动组织</el-dropdown-item>
                <el-dropdown-item @click="openDel(node)">删除组织</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown></span
        >
