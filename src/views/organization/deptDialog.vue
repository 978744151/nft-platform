<template>
  ...
  <el-dialog v-model="addDialog" :title="operate === 'update' ? '修改组织' : '新增组织'" width="428px">
    <avue-form :option="addOptions()" v-model="form" ref="addRef" @submit="addSubmit" v-if="addDialog">
      <template #sort>
  ...
  return {
    ...
    column: [
      ...
      },
      {
        ...
        prop: "titles",
        type: "title",
        value: `组织名称：${currentTree.value.officeName}`,
        styles: {
          fontSize: "14px",
          fonFamily: "Source Han Sans CN, Source Han Sans CN-Regular",
          fontWeight: "Regular",
  ...
  return {
    ...
    column: [
      ...
      },
      {
        ...
        // labelWidth: 0,
        type: "title",
        value: `${currentTree.value.parentName}`,
        styles: {
          fontSize: "14px",
          fonFamily: "Source Han Sans CN, Source Han Sans CN-Regular",
          color: "#0065FF",
